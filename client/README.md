...
*LemmatronApi* | [**InflectionsSourceLangWordIdFiltersGet**](docs/LemmatronApi.md#inflectionssourcelangwordidfiltersget) | **Get** /inflections/{source_lang}/{word_id}/{filters} | Check a word exists in the dictionary and retrieve its root form
